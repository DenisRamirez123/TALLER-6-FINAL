...
String contrasenaCerradura = "20202881*";   //Variable donde almaceno la contraseña definida por el sistema
...
//Constructor
LiquidCrystal_I2C lcdCerradura( 0x27, 16 ,2);   //LCD con direccion 0x20 y tamanio 16x2
  ...
  if(key)
  {
    ...
    if(key == '*')
    {
      ...
      else
      {
        lcdCerradura.setCursor(0,1);
        tone(buzzer, 250 , 500);
        lcdCerradura.print("Clave incorecta");
        delay(1000);
        tone(buzzer, 250 , 500);
        lcdCerradura.setCursor(0,1);
